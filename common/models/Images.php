...
class Images extends CActiveRecord
{
    ...
    public static function im($id) {
       
          return Yii::app()->createAbsoluteUrl("/site/viewimage",array('id' => $id));
      }
    public static function i($id) {
       
          return Yii::app()->createAbsoluteUrl("/site/viewimg",array('id' => $id));
      }
    ...
    public function rules()
    {
        ...
        return array(
            array('name, img, typek, activ_id, options_delivery, info_delivery, coment', 'required'),
    ...
    public function relations()
    {
        ...
        return array(
            'typek0' => array(self::BELONGS_TO, 'Typek', 'typek'),
            'activ' => array(self::BELONGS_TO, 'Activecard', 'activ_id'),
            'painter' => array(self::BELONGS_TO, 'Users', 'painter_id'),
        );
    }
